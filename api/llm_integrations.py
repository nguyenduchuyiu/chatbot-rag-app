...
load_dotenv('/home/huy/Project/hackathon/chatbot-rag-app/ragbot.env')
...
def init_gemini_chat(temperature):
    GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")
    GEMINI_MODEL = os.getenv("GEMINI_MODEL")
    return GoogleGenerativeAI(
        google_api_key=GEMINI_API_KEY, model=GEMINI_MODEL, temperature=temperature
    )
